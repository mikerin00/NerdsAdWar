...
PERSONALITIES = {
    ...
    'DEFENSIVE': {
        'SIEGELINE':             7, 'COUNTERATTACK':       9, 'BRIDGE_CONTROL':        8,
        'REFUSE_FLANK':          7, 'ARTILLERY_DOM':       7, 'ATTRITION':             6,
        'HILL_CONTROL':          6, 'MOBILE_SUPPLY_BUBBLE':5, 'SKIRMISH_SCREEN':       5,
        'STEAMROLLER':           5, 'FEINT_STRIKE':        5, 'GUERRILLA':             4,
        'GRAND_BATTERY':         5, 'OP_ISOLATION':        5, 'ECHELON':               4,
        'DOUBLE_ENVELOP':        4, 'PINCER':              5, 'ENCIRCLEMENT':          4,
        'CENTER_PUSH':           4, 'CAVALRY_RAID':        3, 'BLITZKRIEG':            3,
        'SUPPLY_EDGE_PRESSURE':  4, 'DOUBLE_OP_PRESSURE':  4, 'HAMMER_AND_ANVIL':      4,
        'DEFENSE_IN_DEPTH':      6, 'COUNTER_BATTERY':     7, 'FOREST_DELAY':          5,
        'FEIGNED_RETREAT':       5, 'COMBINED_ARMS':       5, 'CAVALRY_EXPLOIT':       3,
        'DELAYING_ACTION':       4, 'CONTACT_AND_FADE':    3,
    },
    'OPPORTUNIST': {
